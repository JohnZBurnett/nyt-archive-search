import { RECORD_USER_LOGOUT,  UPDATE_ARTICLE_COMMENTS, UPDATE_ARTICLE_END_MONTH_FILTER, UPDATE_ARTICLE_START_MONTH_FILTER, UPDATE_ARTICLE_TITLE_FILTER,  UPDATE_CURRENT_ARTICLE, SAVE_ARTICLE, UPDATE_ARTICLE_COLLECTIONS, FILTER_ARTICLES, ADD_ARTICLES_FROM_FETCH, UPDATE_CURRENT_USER} from '../actions/actionTypes';
...
const rootReducer = (state = {}, action) => {
    ...
    switch(action.type) {
        ...
        case UPDATE_ARTICLE_END_MONTH_FILTER:
          return {
            ...state, articleEndMonthFilter: action.payload
          }
        ...
        case UPDATE_ARTICLE_TITLE_FILTER:
          return {
